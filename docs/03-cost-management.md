...
| Elastic IP(固定のグローバルIPアドレス)の未アタッチ課金 | 未アタッチ(浮いた状態)になると課金対象になる。⚠️ 2024年以降はアタッチ中の通常のパブリックIPv4にも少額課金が発生するようになった(アタッチ中なら無条件に無料、という旧来のルールはもう成り立たない) | EC2終了後は「アドレスの解放」まで実行する。最新料金は必ず公式ページで確認する |
